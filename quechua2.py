...
def conjugacion2(base,numero,persona,tiempo):
    ...
    conjugacion = dp[numero][persona] + ' ' + base + D[tiempo][numero][persona]
...
if conjugado:
    ...
    if audio_file and os.path.exists(audio_file):
        ...
        st.warning(f"No se encontró archivo de audio para la conjugación '{base}'.")
...
if st.button("¡Presiona aquí para conocer más!"):
    ...
    st.markdown(f'<a href="{url}" target="_blank" rel="noopener noreferrer">Quiero conocer más</a>', unsafe_allow_html=True)
